...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="<?= BASE_URL ?>modules/sales/sales_view.php" class="menu-item active">
        ...
        <div class="container-fluid py-4">
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <p class="text-muted">View a all sales records</p>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        ...
                                        <a href="receipt.php?id=<?= $sale['id'] ?>" target="_blank" class="btn btn-sm btn-secondary" title="Print">
