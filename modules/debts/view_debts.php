...
<body>
    ...
    <div class="main-content" id="mainContent">
        <div class="container-fluid py-4">
            <div class="row mb-4">
                <div class="col-12">
                    <h4 class="mb-0">Debts Management</h4>
            ...
            <ul class="nav nav-tabs" id="debtTabs" role="tablist">
                ...
                <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#summary">Debtors Report</a></li>
            </ul>
        ...
        <form method="POST" action="record_payment.php" class="modal-content border-0 ">
