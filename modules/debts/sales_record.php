...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Redirect to sales.php instead of view_debts.php
    header("Location: " . BASE_URL . "modules/debts/sales.php");
    exit;
}
...
if (isset($_GET['id'])) {
    ...
    if (!$debt) {
        ...
        header("Location: " . BASE_URL . "modules/dashboard/sales.php");
        exit;
    }
}
?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="post">
                    ...
                    <a href="<?= BASE_URL ?>modules/sales.php" class="btn btn-secondary">Cancel</a>
                </form>
                <?php else: ?>
                <div class="alert alert-warning">
                    No debt selected. Please select a debt from the <a href="<?= BASE_URL ?>modules/dashboard/sales.php">sales page</a>.
                </div>
                <?php endif; ?>
            </div>
        </div>
